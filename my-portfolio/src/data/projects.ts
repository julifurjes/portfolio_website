...
export const PROJECTS: Project[] = [
  {
    ...
    sections: {
      ...
      findings: {
        title: "Key Findings",
        content: "The analysis identified multiple distinct depression trajectory patterns across the longitudinal dataset, each characterized by different demographic and behavioral profiles.\n\nStable Trajectory: This group showed consistently lower depression symptoms over time, with patterns suggesting connections between employment status, lifestyle factors, and mental health stability.\n\nFluctuating Trajectory: Characterized by variable symptom severity across time points, this trajectory showed associations with multiple demographic factors and health-related behaviors that may influence mental health fluctuations.\n\nSevere Trajectory: This group demonstrated more persistent and elevated depression symptoms, with notable patterns in age distribution, employment circumstances, and comorbidity profiles.\n\nImpact: These findings demonstrated how demographic, health, and lifestyle factors interact with depression trajectories over time, providing potential insights for understanding mental health patterns in longitudinal data. The work showcases my ability to handle complex statistical challenges, communicate across disciplines, and produce research-grade documentation while maintaining confidentiality of specific research outcomes."
      }
    }
  },
  {
